...
[@inline] let balance_of (state: mock_fa2_state) (param: fa2_balance_of_param) : operation list * mock_fa2_state =
...
[@inline] let fa2_run_transfer (state, xs: fa2_state * fa2_transfer list) : fa2_state * operation list =
  let state =
...
[@inline] let transfer (state: mock_fa2_state) (xs: fa2_transfer list) : operation list * mock_fa2_state =
...
[@inline] let update_operators (state: mock_fa2_state) (xs: fa2_update_operator list) : operation list * mock_fa2_state =
  let { fa2_state = fa2_state; total_token = total_token; metadata = metadata; } = state in (* deconstruct *)
...
let main (op, state: mock_fa2_params * mock_fa2_state): operation list * mock_fa2_state =
...
let view_get_balance ((owner, token_id), state: (address * fa2_token_id) * mock_fa2_state) : nat =
  fa2_get_balance (state.fa2_state, owner, token_id)

let view_total_supply (token_id, state: fa2_token_id * mock_fa2_state) : nat =
...
let view_is_operator ((owner, (operator, token_id)), state: (address * (address * fa2_token_id)) * mock_fa2_state) : bool =
