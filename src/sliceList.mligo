...
[@inline] let slice_list_to_auction_state (auctions: liquidation_auctions) (l: slice_list) : liquidation_auctions =
  match l with SliceList meta ->
    ...
    in
    let burrow_slices = Big_map.update meta.slice_list_burrow burrow_liquidation_slice auctions.burrow_slices in
...
*)
[@inline] let slice_list_append (l:slice_list) (auctions:liquidation_auctions) (root:liquidation_auction_id) (queue_end:queue_end) (slice_contents:liquidation_slice_contents) : (liquidation_auctions * slice_list * slice_list_element) =
...
[@inline] let slice_list_remove (l:slice_list) (auctions:liquidation_auctions) (e:slice_list_element) : (liquidation_auctions * slice_list * liquidation_auction_id * liquidation_slice_contents) =
  ...
  | None -> (failwith internalError_SliceListRemoveEmptyList : liquidation_auctions * slice_list * avl_ptr * liquidation_slice_contents)
  | Some bounds ->
