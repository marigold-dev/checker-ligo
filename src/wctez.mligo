...
[@view]
let get_balance ((owner, token_id): (address * FA2.fa2_token_id)) (state: wctez_state) : nat =
  fa2_get_balance (state.fa2_state, owner, token_id)

[@view]
let total_supply (token_id: FA2.fa2_token_id) (state: wctez_state) : nat =
...
[@view]
let all_tokens (_unit: unit) (_state: wctez_state) : FA2.fa2_token_id list =
  [ Tokens.wctez_token_id ]

[@view]
let is_operator ((owner, (operator, token_id)): (address * (address * FA2.fa2_token_id))) (state: wctez_state) : bool =
